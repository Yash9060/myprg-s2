/*Problem statement
================================
Given two words, verify whether they are anagram or not. 
Two strings are anagrams if they are rearrangements of the same set of letters. 
for example , the words 'creative'and 'reactive' have same set of letters, so they are anagrams. */
